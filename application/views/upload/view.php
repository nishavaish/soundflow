    ...
    <div class="flex items-start gap-8">
      ...
      <div class="flex-1">
        <div class="flex items-start justify-between">
          <div>
            <h1 class="text-4xl font-bold mb-6"><?php echo html_escape($release->title) ?></h1>
          ...
          <?php if (!empty($tracks)): ?>
            <ul class="space-y-3">
              <?php foreach ($tracks as $t): ?>
                <li class="p-3  rounded border border-border flex items-center justify-between">
                  <div>
                    <div class="font-medium text-black"><?php echo html_escape($t->title) ?></div>

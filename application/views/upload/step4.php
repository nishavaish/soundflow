...
<body class="min-h-screen bg-white text-black">
  ...
  <div class="bg-gradient-to-r from-[#b90606] to-[#ff1a1a] py-6">
    <div class="container mx-auto px-6 flex items-center justify-between text-white">
      <h1 class="text-4xl font-bold">Artwork</h1>
  ...
  <div class="container mx-auto px-6 py-12 max-w-4xl">
    ...
    <div class="bg-card border-b border-zinc-400/30 rounded-lg p-8">
      ...
      <form method="post" enctype="multipart/form-data" action="<?= base_url('UploadSingle/step4') ?>" class="space-y-10">
   ...
   <?php
    ...
    <input type="hidden" name="<?php echo $csrf_name; ?>" value="<?php echo $csrf_hash; ?>" />
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="templateGrid">
            <?php for($i=1; $i<=8; $i++): ?>
              <div
                ...
                class="template-box aspect-square rounded-lg bg-gradient-to-br from-gray-400 to-gray-100 cursor-pointer border-b border-zinc-400/30 flex items-center justify-center hover:scale-105 transition-all">
        ...
        <div class="flex justify-between pt-8">
          <a href="<?= base_url('UploadSingle/step3') ?>"

...
<body class="min-h-screen bg-white text-black">
  ...
  <div class="bg-gradient-to-r from-[#b90606] to-[#ff1a1a] py-6">
    <div class="container mx-auto px-6 flex items-center justify-between">
      <h1 class="text-4xl font-bold text-white"> Edit Release — Step 4: Artwork </h1>

      <div class="flex items-center gap-3">
        <div class="w-16 h-16 rounded-full border-2 border-white/30 flex items-center justify-center">
          <div class="text-center leading-tight">
            <div class="text-2xl font-bold text-white">4 <span class="text-xs">/ 4</span></div>
            ...
            <div class="flex gap-6 items-start">
              ...
              <div>
                ...
                <div class="flex gap-2">
                  <label for="artwork" class="px-4 py-2 rounded bg-white border border-border hover:bg-white/5 cursor-pointer text-sm">
                    Replace artwork
                    <input id="artwork" type="file" name="artwork" accept="image/*" class="hidden">
                  </label>

                  <label class="px-4 py-2 rounded bg-white border border-border cursor-pointer text-sm">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="templateGrid">
            ...
            ?>
              <div
                ...
                class="template-box aspect-square rounded-lg bg-gradient-to-br from-gray-400 to-gray-100 cursor-pointer border-b <?= $is_selected ? 'template-selected' : 'border-transparent' ?> flex items-center justify-center hover:scale-105 transition-all"
                  >

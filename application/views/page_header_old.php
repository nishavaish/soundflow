 <header class="border-b border-border bg-black">
    <div class="container mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center gap-8 text-sm">
        <a href="<?php echo site_url('Dashboard') ?>" class="hover:text-primary transition-colors text-white">DASHBOARD</a>
		
		<div class="relative group" id="releasesDropdown">

		  <!-- Trigger -->
		  <button  id="releasesBtn" class="flex items-center gap-1 text-white hover:text-primary transition-colors focus:outline-none" >
			MY RELEASES
        ...
        <a href="<?= site_url('my-assets') ?>" class="hover:text-primary transition-colors text-white"> ASSEST LIBRARY</a>
        <a href="<?= site_url('analytics') ?>" class="hover:text-primary transition-colors text-white"> ANALYTICS</a>
       <!-- <a href="#" class="hover:text-primary transition-colors text-white">ARTIST SERVICES</a> -->
	   
	    <a href="<?= site_url('profile') ?>" class="hover:text-primary transition-colors text-white"> PROFILE</a>
      </nav>
        ...
        <a href="<?php echo site_url('upload') ?>"
		  ...
		  <div class="relative" id="profileDropdown">
			  ...
			  <button id="profileBtn"
				...
				<i data-lucide="chevron-down" class="w-4 h-4 text-white/70 hidden md:block"></i>
			  </button>

...
<body class="min-h-screen bg-gradient-to-br from-black to-[#1b0e26] text-white">
  ...
  <div class="bg-gradient-to-r from-[#3b2e10] to-[#401720] py-6">
    <div class="container mx-auto px-6 flex items-center justify-between">
      <h1 class="text-4xl font-bold">Edit Release — Step 1: Release Details</h1>
    ...
    <input type="hidden" name="<?php echo $csrf_name; ?>" value="<?php echo $csrf_hash; ?>" />
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            required
            class="w-full bg-[#0a0a0a] border border-border rounded-lg px-4 py-2 focus:outline-none focus:border-primary"
          >
        </div>
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            class="w-full bg-[#0a0a0a] border border-border rounded-lg px-4 py-2 focus:outline-none focus:border-primary text-sm"
          >
        </div>
...
<select id="genre" name="genre" required class="w-full bg-[#0a0a0a] border border-border rounded-lg px-4 py-2 focus:outline-none focus:border-primary">

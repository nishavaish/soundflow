    ...
    <div class="max-w-6xl mx-auto px-6 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex bg-card border border-border rounded-lg overflow-hidden">
                    <button id="gridBtn" class="px-3 py-2 flex items-center gap-1 hover:bg-gray-300">
                        <i data-lucide="grid"></i> <span class="hidden sm:inline">Grid</span>
                    </button>
                    <button id="listBtn" class="px-3 py-2 flex items-center gap-1 hover:bg-gray-300">
                        <i data-lucide="list"></i> <span class="hidden sm:inline">List</span>
                    </button>
                </div>

                <a href="<?= site_url('UploadAlbum/step1') ?>" class="px-4 py-2 rounded bg-primary text-white">
                    Create Album
                </a>
            </div>
        </div>
        ...
        <div id="gridWrapper" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <?php foreach ($albums as $album): ?>
                ...
                <div
                    class="card delete-anim release-card-<?= $album_id ?> rounded-lg overflow-hidden border border-border card-hover relative">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-4 flex items-center justify-end gap-4">
                            ...
                            <?php if ((int) $album->is_active === 0): ?>
                                ...
                                <a href="<?= site_url('UploadAlbum/edit/1/' . $album_id) ?>" title="Edit">
                                    <i data-lucide="pencil" class="w-5 h-5 text-yellow-400 hover:text-yellow-300"></i>
                                </a>

                                <button class="delete-btn" data-id="<?= $album_id ?>"
                                    data-title="<?= htmlspecialchars($album->album_title, ENT_QUOTES, 'UTF-8') ?>"
                                    title="Delete">
            ...
            <?php foreach ($albums as $album): ?>
                ...
                <div class="list-row delete-anim release-card-<?= $album_id ?>" data-id="<?= $album_id ?>">
                    ...
                    <div class="text-sm muted">
                        ...
                        <span class="ml-2 text-xs bg-gray-300 px-2 py-1 rounded"><?= $album->album_type ?></span>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <?php if ((int) $album->is_active === 0): ?>
                            ...
                            <!-- Delete -->
                            <button class="delete-btn" data-id="<?= $album_id ?>"
                                data-title="<?= htmlspecialchars($album->album_title, ENT_QUOTES, 'UTF-8') ?>" title="Delete">
                                <i data-lucide="trash-2" class="w-5 h-5 text-red-400 hover:text-red-300"></i>
                            </button>

                        <?php else: ?>

                            <!-- Approved Badge (same row) -->
                            <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full

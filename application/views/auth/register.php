<div class="w-full max-w-md mx-auto">
    <div class="bg-white border border-zinc-800 rounded-2xl shadow-xl p-8">
        <div class="mb-6 text-center">
            ...
            <h1 class="text-2xl font-bold mb-1 text-black">Create your account</h1>
        ...
        <div class="mb-6">
            <label class="block text-sm mb-1 text-black" for="password_confirm">Confirm Password</label>
            <input
                type="password"
                id="password_confirm"

...
<div class="container mx-auto px-6 py-8 text-white">
  ...
  class="px-4 py-2 bg-primary text-black rounded font-semibold">
  + Create Project
</button>
...
<div id="createProjectForm"
     class="bg-card border border-border rounded-lg p-6 mb-8 hidden overflow-hidden transition-all duration-300 ease-out">
...
<input type="hidden"
  ...
  <div class="space-y-4">
    <?php foreach ($projects as $p): ?>
      <div
        class="bg-card border border-border rounded-lg p-5 flex justify-between items-center">
  ...
  • <?= $p->asset_count ?> assets
    ...
    <?php if (empty($projects)): ?>
      <div class="bg-card border border-border rounded-lg p-8 text-center text-muted">

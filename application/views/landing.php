...
<body class="min-h-screen bg-white text-black">
    ...
    <section class="container mx-auto px-4 py-20 text-center">
        <h2 class="text-5xl md:text-6xl font-bold mb-6 leading-[1.2]">
        Release <span class="text-primary-custom">Your Music</span> <span class="block">Everywhere</span>
        </h1>
    ...
    <section class="bg-zinc-200/50 py-16">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">
                <span class="text-primary-custom">Enjoy Unlimited Distribution from</span> <span class="block">only $22.99 per year</span>
            </h2>
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 mb-8 opacity-80">
                <div class="text-2xl font-bold"><img height="80" width="60" class="m-auto" src="https://static.vecteezy.com/system/resources/previews/016/716/458/non_2x/spotify-icon-free-png.png"> Spotify</div>
                <div class="text-2xl font-bold text-center"><img height="80" width="60" class="m-auto" src="https://images.icon-icons.com/2201/PNG/512/apple_music_logo_square_icon_134020.png" > Apple Music</div>
                <div class="text-2xl font-bold"><img height="80" width="60" class="m-auto" src="https://upload.wikimedia.org/wikipedia/commons/e/ef/Youtube_logo.png"> YouTube</div>
                <div class="text-2xl font-bold"><img height="80" width="60" class="m-auto" src="https://upload.wikimedia.org/wikipedia/commons/d/de/Amazon_icon.png"> Amazon</div>
                <div class="text-2xl font-bold"><img height="80" width="60" class="m-auto" src="https://cdn.iconscout.com/icon/free/png-256/free-tidal-logo-icon-svg-download-png-3222734.png"> Tidal</div>
                <div class="text-2xl font-bold"><img height="80" width="60" class="m-auto" src="https://assets.streamlinehq.com/image/private/w_300,h_300,ar_1/f_auto/v1/icons/logos/beatport-9fzjxb3f59m9hnp4erst0i.png/beatport-2viwxwk3sxr1do6haqnmlx.png?_a=DATAg1AAZAA0"> Beatport</div>
            </div>
    ...
    <section id="why-soundflow" class="bg-zinc-200/50 py-20">
    ...
    <section id="features" class="bg-white py-20">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                <!-- Feature 1 -->
                <div class="bg-zinc-200/50 border border-zinc-300 rounded-lg p-6 hover:border-primary-custom/50 transition-all">
                    <!-- Globe Icon -->
                    ...
                    <p class="text-gray-600">Reach 150+ streaming platforms worldwide</p>
                </div>
                ...
                <div class="bg-zinc-200/50 border border-zinc-300 rounded-lg p-6 hover:border-primary-custom/50 transition-all">
                    ...
                    <p class="text-gray-600">All royalties go directly to you</p>
                </div>
                ...
                <div class="bg-zinc-200/50 border border-zinc-300 rounded-lg p-6 hover:border-primary-custom/50 transition-all">
                    ...
                    <p class="text-gray-600">Track your music performance live</p>
                </div>
                ...
                <div class="bg-zinc-200/50 border border-zinc-300 rounded-lg p-6 hover:border-primary-custom/50 transition-all">
                    ...
                    <p class="text-gray-600">Release as much music as you want</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Artist Services -->
    <section id="artist-services" class="bg-zinc-200/50 py-20">
        <div class="container mx-auto px-4">
            <!-- Header -->
            <div class="text-center mb-16">
                <h2 class="text-5xl md:text-6xl font-bold mb-4">Artist <span class="text-primary-custom">Services</span></h2>
            ...
            <!-- Prepare Your Music -->
            <div class="mb-20">
                <h3 class="text-4xl md:text-5xl font-bold text-center mb-4">Prepare <span class="text-primary-custom">Your Music</span></h3>
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <!-- Card 1 -->
                    <div class="bg-zinc-200 border border-zinc-300 rounded-xl p-6 text-center">
            ...
            <!-- Get Ready To Sell -->
            <div class="mb-20">
                <h3 class="text-4xl md:text-5xl font-bold text-center mb-4">Get Ready To <span class="text-primary-custom">Sell Your Music </span></h3>
                <p class="text-center text-gray-400 mb-12 max-w-4xl mx-auto">
            ...
            <!-- Promote Your Music -->
            <div>
                <h3 class="text-4xl md:text-5xl font-bold text-center mb-4">Promote <span class="text-primary-custom">Your Music</span></h3>
                <p class="text-center text-gray-400 mb-12 max-w-4xl mx-auto">
    ...
    <section class="container mx-auto px-4 py-20">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-zinc-200 border border-zinc-300 rounded-2xl p-8 text-center">

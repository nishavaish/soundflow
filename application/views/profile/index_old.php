  ...
  <div class="grid md:grid-cols-2 gap-6">
    ...
    <div class="bg-card border border-border rounded-lg p-6">
      ...
      <form id="bankForm" class="space-y-4">
        <input name="account_name" value="<?= $bank->account_name ?? '' ?>" placeholder="Account Holder Name" class="w-full bg-background border border-border px-4 py-2 rounded" required>
        <input name="account_number" value="<?= $bank->account_number ?? '' ?>" placeholder="Account Number" class="w-full bg-background border border-border px-4 py-2 rounded" required>
        <input name="ifsc" value="<?= $bank->ifsc ?? '' ?>" placeholder="IFSC Code" class="w-full bg-background border border-border px-4 py-2 rounded uppercase" required>
        <input name="bank_name" value="<?= $bank->bank_name ?? '' ?>" placeholder="Bank Name" class="w-full bg-background border border-border px-4 py-2 rounded" required>

        <button class="w-full bg-primary py-2 rounded font-semibold">
          Save Bank Details
        </button>
      </form>
    </div>
    ...
    <div class="bg-card border border-border rounded-lg p-6">
      ...
      <form id="invoiceForm" enctype="multipart/form-data" class="space-y-4">
        <input name="title" placeholder="Invoice Title" class="w-full bg-background border border-border px-4 py-2 rounded" required>
       <select name="invoice_month"
        class="w-full bg-background border border-border px-4 py-2 rounded text-white"
        required>
